                ...
                <ScrollView>
                    <View style={{ flex: 1, lexDirection: 'column',paddingBottom:30 }}>
                        ...
                        <View style={{ padding: 10, height: 250, width: '100%' }}>
                            <Image source={{ uri: item.image1 }} style={{ width: '100%', height: '100%', alignSelf: 'center', resizeMode: 'cover' }} />
                        </View>
                        ...
                        <View style={{ padding: 10, height: 320, width: '100%' }}>
                            <Image source={{ uri: item.image3 }} style={{ width: '100%', height: '100%', alignSelf: 'center', resizeMode: 'cover' }} />
                        </View>
