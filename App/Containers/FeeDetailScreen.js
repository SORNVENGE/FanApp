                ...
                <ScrollView>
                    <View style={{ flex: 1, lexDirection: 'column',paddingBottom:30 }}>
                        ...
                        <View style={{ padding: 10, height: 250, width: '100%' }}>
                            <Image source={Images.img1} style={{ width: '100%', height: '100%', alignSelf: 'center', resizeMode: 'cover' }} />
                        </View>
                        ...
                        <View style={{ padding: 10, height: 250, width: '100%' }}>
                            <Image source={Images.img2} style={{ width: '100%', height: '100%', alignSelf: 'center', resizeMode: 'cover' }} />
                        </View>
                        <View style={{ backgroundColor: Colors.main_color, marginTop: 10, padding: 10, alignItems: 'center' }}>
                        ...
                        <View style={{ padding: 10, height: 320, width: '100%' }}>
                            <Image source={Images.img3} style={{ width: '100%', height: '100%', alignSelf: 'center', resizeMode: 'cover' }} />
                        </View>
