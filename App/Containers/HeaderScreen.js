...
class HeaderScreen extends Component {
    ...
    render() {
        ...
        if (data) {
            ...
            title = titleHeader;
            screen = screenName;
            if (screen == "NewsScreen" || screen=="DetailScreen" || screen=="MainProgramScreen"|| screen=="FeeScreen"|| screen=="YoutubeScreen"|| screen=="ContactScreen"|| screen=="SettingScreen"|| screen=="FacebookScreen" || screen=="ELearningScreen" || screen=="AdmissionScreen"|| screen=="FeeDetailScreen"|| screen=="MainProgramDetailScreen"  ){
                statusLogo = false
            }
            if (!statusHeader) {
                return false;
